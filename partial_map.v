...
Theorem t_update_neq : forall (A : Type) (m : total_map A) x1 x2 v,
  ...
  (x1 !-> v ; m) x2 = m x2.
Proof.
  intros A m x1 x2 v neq_x1_x2.
  unfold t_update. apply String.eqb_neq in neq_x1_x2. rewrite neq_x1_x2.
  reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  intro i.
  destruct (String.eqb_spec x i) as [H | H].
...
Theorem t_update_permute : forall (A : Type) (m : total_map A)
  ...
  (x2 !-> v2 ; x1 !-> v1 ; m).
Proof.
  intros A m v1 v2 x1 x2 ineq_x1_x2.
  apply functional_extensionality.
  intro i.
  destruct (String.eqb_spec x1 i) as [H1 | H1]; destruct (String.eqb_spec x2 i) as [H2 | H2].
  - rewrite <- H1 in H2. exfalso. apply ineq_x1_x2. apply H2.
  - rewrite H1. apply String.eqb_neq in H2. unfold t_update. rewrite String.eqb_refl. rewrite H2. reflexivity.
  - unfold t_update. apply String.eqb_neq in H1. rewrite H1. rewrite H2. reflexivity.
  - unfold t_update. apply String.eqb_neq in H1. rewrite H1.
                     apply String.eqb_neq in H2. rewrite H2.
    reflexivity.
Qed.
(** [] *)
